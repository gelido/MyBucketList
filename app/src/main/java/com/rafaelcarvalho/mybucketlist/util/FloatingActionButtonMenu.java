...
public class FloatingActionButtonMenu extends ViewGroup {
        ...
        public void onClick(View v) {
            if (v instanceof FloatingActionButton) {
                ...
                if (onMenuItemClickListener != null) {
                    onMenuItemClickListener.onMenuItemClick(FloatingActionButtonMenu.this, i, (FloatingActionButton) v);
                }
            } else if (v instanceof TextView) {
                int i = mMenuItemLabels.indexOf(v);
                if (onMenuItemClickListener != null) {
                    onMenuItemClickListener.onMenuItemClick(FloatingActionButtonMenu.this, i, mMenuItems.get(i));
                }
            }
            close();
        }
    ...
    public void setMenuButton(FloatingActionButton mMenuButton) {
...
//    }
    ...
    public interface OnMenuItemClickListener {
        void onMenuItemClick(FloatingActionButtonMenu fam, int index, FloatingActionButton item);
    }
